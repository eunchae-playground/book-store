...
function OrderDeliveryForm({ formRegister, formErrors }: Props) {
  const { deliveryInfo, updateDeliveryInfoField } = useCreateOrderStore();
  const { address, detailAddress, receiver, contact } = deliveryInfo;

  const onCompletedFindAddress = (address: string) => {
    updateDeliveryInfoField("address", address);
  };
      ...
      <div className="form-container">
        ...
        <fieldset>
          ...
          <InputText
            ...
            value={detailAddress}
            onChange={(event) =>
              updateDeliveryInfoField("detailAddress", event.target.value)
            }
          />
        ...
        <fieldset>
          ...
          <InputText
            ...
            value={receiver}
            onChange={(event) =>
              updateDeliveryInfoField("receiver", event.target.value)
            }
          />
          {formErrors.receiver && (
        ...
        <fieldset>
          ...
          <InputText
            ...
            value={contact}
            onChange={(event) =>
              updateDeliveryInfoField("contact", event.target.value)
            }
          />
          {formErrors.contact && (
